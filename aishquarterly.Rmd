...
```{r}
master_log_path <- "//Users/aishwarya/Desktop/Live Documents/Master Log (version2).xlsx"
phone_term_path <- "/Users/aishwarya/Desktop/Live Documents/Link2Care Phone Terminations.xlsx"
remote_path <- "/Users/aishwarya/Desktop/Live Documents/L2C Remote Interview & Redcap Tracking.xlsx"
ema_initial_pay_approach_path <- "/Users/aishwarya/Desktop/Live Documents/ema_data comparison.xlsx"
ema_15_day_path <- "/Users/aishwarya/Desktop/Live Documents/15_Day_EMA.xlsx"
arrest_path <- "/Users/aishwarya/Desktop/Link2Care/current_arrest_data.xlsx"
bridge_path <- "/Users/aishwarya/Desktop/Link2Care/bridge_session_minutes.xlsx"
```
...
# 2022-4-18: Master log screened in imported with 329 rows and 55 columns.
```
...
master_log_combined <- master_log_combined %>% 
  mutate(
    across(
      c(date_v2_presented:date_v5_presented),
